...
export declare class Account {
     ...
     */
    listAccounts(pagination: AccountPagination, verbose: false, options: {
        indexedAmounts: false;
        isMineOnly: boolean;
    }): Promise<Array<AccountResult<string, string>>>;
    /**
     * Get information about all accounts on chain
     ...
     */
    listAccounts(pagination: AccountPagination, verbose: true, options: {
        indexedAmounts: true;
        isMineOnly: boolean;
    }): Promise<Array<AccountResult<AccountOwner, AccountAmount>>>;
    /**
     * Get information about all accounts on chain
    ...
    listAccounts(pagination: AccountPagination, verbose: false, options: {
        indexedAmounts: true;
        isMineOnly: boolean;
    }): Promise<Array<AccountResult<string, AccountAmount>>>;
    /**
     ...
     */
    getAccount(owner: string, pagination: AccountPagination, options: {
        indexedAmounts: true;
     ...
     */
    getTokenBalances(pagination: AccountPagination, indexedAmounts: true, options: {
        symbolLookup: false;
    }): Promise<AccountAmount>;
    /**
     * Get the balances of all accounts that belong to the wallet
     ...
     */
    getTokenBalances(pagination: AccountPagination, indexedAmounts: false, options: {
        symbolLookup: true;
    }): Promise<string[]>;
    /**
     * Get the balances of all accounts that belong to the wallet
     ...
     * @return {Promise<string>}
     */
    accountToAccount(from: string, payload: BalanceTransferPayload, options?: BalanceTransferAccountOptions): Promise<string>;
    /**
     ...
     * @return {Promise<string>}
     */
    accountToUtxos(from: string, payload: BalanceTransferPayload, options?: BalanceTransferAccountOptions): Promise<string>;
    /**
     ...
     */
    listAccountHistory(owner?: OwnerType | string, options?: AccountHistoryOptions): Promise<AccountHistory[]>;
    /**
     ...
     * @return {Promise<AccountHistory>}
     */
    getAccountHistory(owner: string, blockHeight: number, txn: number): Promise<AccountHistory>;
    /**
     ...
     */
    historyCount(owner?: OwnerType | string, options?: AccountHistoryCountOptions): Promise<number>;
    /**
     ...
     * @return {Promise<string>}
     */
    sendTokensToAddress(from: AddressBalances, to: AddressBalances, options?: SendTokensOptions): Promise<string>;
    /**
     ...
     */
    listBurnHistory(options?: BurnHistoryOptions): Promise<BurnHistory[]>;
    /**
